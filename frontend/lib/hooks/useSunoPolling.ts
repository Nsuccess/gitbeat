...
interface SunoStatusData {
  ...
  status: 'PENDING' | 'PROCESSING' | 'TEXT_SUCCESS' | 'FIRST_SUCCESS' | 'SUCCESS' | 'FAILED';
  type: string;
    ...
    try {
      ...
      switch (statusData.status) {
        ...
        case 'PROCESSING':
          ...
          break;
        case 'TEXT_SUCCESS':
          setProgress('Lyrics generated, creating audio...');
          break;
        case 'FIRST_SUCCESS':
          setProgress('First track ready, finalizing...');
          break;
        case 'SUCCESS':
